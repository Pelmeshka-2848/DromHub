...
namespace DromHub
{
    ...
    {
        private static readonly string connectionString = "Server=tcp:localhost;Database=DromHubDB;User Id=DromHub;Password=admin1234;TrustServerCertificate=True;\r\n";
