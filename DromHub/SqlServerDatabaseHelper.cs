    ...
    public static class DatabaseHelper
    {
        ...
        public static async Task InitializeDatabaseAsync()
        {
            try
            {
                ...
                // Можно добавить логику создания таблиц, миграций и т.п.
                // Для проверки подключения достаточно просто открыть и закрыть соединение
            }
            catch (Exception ex)
            {
                // Обработка ошибки и логирование
                await LogToFileAsync("Ошибка инициализации базы: " + ex.Message);
                throw;
            }
        }
        /// <summary>
        /// Асинхронное логирование текста в локальный файл приложения.
        /// </summary>
        public static async Task LogToFileAsync(string text)
        {
            try
            {
                ...
                await FileIO.AppendTextAsync(logFile, text + Environment.NewLine);
            }
            catch
            {
        ...
        /// <summary>
        /// Асинхронный поиск деталей по номеру с расширенным набором возвращаемых полей.
        /// </summary>
